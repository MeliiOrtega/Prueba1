   ...
   {{--  {{$section}} --}}
    ...
    <div  x-data="{ open: false }" >
        <a x-show="!open" x-on:click="open = true" class="flex items-center cursor-pointer" >
            ...
            Agregar nueva sección de contenido
        </a>

        <article class="card" x-show="open"  x-on:click.away = "open = false">
            <div class="card-body bg-indigo-100">
                <h1 class="text-xl font-bold mb-4">Agregar nueva sección de contenido</h1>
                <div class="mb-4">
                    <input wire:model="name" class="w-full" type="text" placeholder="Escriba el nombre de la sección">
                    @error('name')
